# Western Australia Price Analytics
A data analytics project exploring regulard unleaded petrol prices across the Perth Metropolitan area.
The project uses Western Australian FuelWatch data from January to June 2026 to identify fuel price trends, compare suburbs and brands, rank consistently competitive stations then finally estimate savings for users.

## Project OverView
Fuel prices can vary significantly depending on the day, suburb, brand and station. As a student who use car to commute everyday, I understand that understanding trends will help save money, so I deicded to do this project.
...
## Data source
The project uses retail fuel data published by:
